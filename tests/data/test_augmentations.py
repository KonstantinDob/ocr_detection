...
class TestAugmentor:
    ...
    @pytest.mark.parametrize(
        'size',
        [(128, 128, 3), (256, 256, 2), (128, 1280, 4),
         (1280, 128, 2), (10, 10, 3), (1280, 1280, 3)]
    )
    def test_different_sizes(self, load_config,
        ...
        augmentor.rotation_aug(image, rotate_vals=np.random.random(2))
        augmentor.resize_normalize(image, is_mask=is_mask)
        assert True
